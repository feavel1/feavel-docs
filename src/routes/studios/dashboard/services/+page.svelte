...
<div class="space-y-6">
	<div class="flex items-center justify-between">
		...
		{#if isApproved}
			<a
				href="/studios/dashboard/services/new"
				class="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none"
			>
				Create Service
			</a>
		{/if}
